        ...
        <div className="services-page">
            ...
            <header className="service-header">
                <div className="service-overlay">
                    ...
                    <br></br>
                    {/* <a href='signup'><button className="signup-button">Sign Up Now</button></a> */}
                </div>
            </header>
                ...
                <article>
                    <div class="bg-secondary article-wrapper">
                        ...
                        <div class="article-body">
                            ...
                            <p>
                            Customizable henna party packages for bridal showers, weddings, birthdays, and other celebrations, including on-site henna services and group discounts.     </p>
                ...
                <article>
                    ...
                    <div class="bg-secondary article-wrapper">
                        ...
                        <div class="article-body">
                            ...
                            <p>
                            Quick and convenient mehendi application services for busy individuals, offering intricate designs in a short time frame.     </p>
                ...
                <article>
                    ...
                    <div class="bg-secondary article-wrapper">
                        ...
                        <div class="article-body">
                            ...
                            <p>
                            High-quality henna products such as natural henna cones, henna powder, and henna kits for at-home application and professional use. </p>
